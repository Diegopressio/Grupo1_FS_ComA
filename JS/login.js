...
(function(){
    ...
    form.addEventListener('submit', function(e){
        ...
        // Login correcto: guardamos usuario actual y redirigimos
        localStorage.setItem('currentUser', JSON.stringify({ username: found.username, email: found.email }));
        message.style.color = 'green';
        message.textContent = 'Bienvenido ' + found.username + '. Redirigiendo...';
